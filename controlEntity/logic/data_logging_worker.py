...
class DataLoggingWorker(QObject):
    ...
    def _on_log_timer(self):
        ...
        flow_rate_1 = self.utils.rpm_to_ul_per_min(1, float(evoflow_snapshot.get("pump_1_speed", 0.0)))
        ...
        row = (
            ...
            format(float(evoflow_snapshot.get("od_bioreactor_value", 0.0)), ".4f"),
            int(evoflow_snapshot.get("od_lagoon_status", 0)),
            format(float(evoflow_snapshot.get("od_lagoon_value", 0.0)), ".4f"),
            ...
            format(float(evoflow_snapshot.get("phtCount_lagoon_value", 0.0)), ".4f"),
